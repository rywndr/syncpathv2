...
export const GRID_TEMPLATE =
    "20px 28px minmax(80px, 2fr) minmax(50px, 0.4fr) minmax(70px, 0.4fr) minmax(80px, 0.3fr) minmax(80px, 0.3fr) 40px 40px minmax(60px, 0.9fr) minmax(60px, 0.9fr) 26px 26px 26px";
