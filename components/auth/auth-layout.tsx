    ...
    return (
        <div className="grid min-h-screen lg:grid-cols-2">
            <div className="relative hidden lg:block">
                <div className="sticky top-0 h-screen w-full pr-4">
                    <div
                        className="relative h-full w-full overflow-hidden rounded-r-4xl shadow-2xl shadow-blue-900/20 bg-cover bg-center bg-no-repeat"
